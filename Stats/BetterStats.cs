...
namespace Bottleneck.Stats
{
    public class BetterStats : MonoBehaviour
    {
        ...
        private static EnhancedUIProductEntryElements EnhanceUIProductEntry(UIProductEntry __instance)
        {
            ...
            maxProductionLabel.text = "Theoretical max";// "theoreticalMaxLabel".BottleneckString(PluginConfig.GetLanguage()); 
            ...
            maxProductionUnit.text = "/min"; //"perMinLabel".BottleneckString(PluginConfig.GetLanguage());

            var maxConsumptionLabel = CopyText(__instance.consumeLabel, new Vector2(maxOffset, 0));
            maxConsumptionLabel.text = "Theoretical max";//"theoreticalMaxLabel".BottleneckString(PluginConfig.GetLanguage());
            ...
            maxConsumptionUnit.text = "/min";// "perMinLabel";
            ...
            counterProductionLabel.text = "Producers";// "producersLabel".BottleneckString(PluginConfig.GetLanguage());
            ...
            counterConsumptionLabel.text = "Consumers"; // "consumersLabel".BottleneckString(PluginConfig.GetLanguage());
        ...
        public static void UIStatisticsWindow__OnOpen_Postfix(UIStatisticsWindow __instance)
        {
            ...
            text.text = "Display /sec"; //"dispPerSecLabel".BottleneckString(PluginConfig.GetLanguage());
            ...
            _placeholder.text = "Filter"; // "filterLabel".BottleneckString(PluginConfig.GetLanguage());
